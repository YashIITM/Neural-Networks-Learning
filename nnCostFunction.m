function [J, grad] = nnCostFunction(nn_params, input_layer_size, hidden_layer_size, num_labels, X, y, lambda)
  ...
  % Theta1 = 25 x 401
  % Theta2 = 10 x 26
  %nn_params is a one D vector that contains the values of Theta1 and
  %Theta2 unrolled:
  ...
  % Part 1: Calculating J w/o Regularization : Feedforward the NN and return the cost in the variable J 
